...
#if VIDEOS_ALLOWED //VIDEO IN THE START, MAY NOT WORK
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Expurunkin\' by'], 40);
					#else
					createCoolText(['ninjamuffin99', 'phantomArcade', 'kawaisprite', 'evilsk8er']);
					#end
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Santiago', 40);
					#else
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['This is an update of'], -40);
					#else
					createCoolText(['This is an update of'], -40);
					#end
				case 8:
					addMoreText('Expurfunkin\' 3.5', -40);
				case 9:
					deleteCoolText();
				case 10:
